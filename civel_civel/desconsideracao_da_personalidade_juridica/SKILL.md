---
name: civel_civel/desconsideracao_da_personalidade_juridica
description: >
  Gera incidente de desconsideração da personalidade jurídica (IDPJ), com fundamento nos arts. 133-137 do CPC/2015, art. 50 do CC/2002 (teoria maior) ou art. 28 do CDC (teoria menor), para atingir o patrimônio pessoal dos sócios ou administradores (desconsideração direta) ou o patr
triggers:
  - "Para atingir bens dos sócios quando a pessoa jurídica está insolvente e há evidê"
  - "Quando a empresa foi usada para desvio de finalidade ou confusão patrimonial (ar"
  - "Em execuções frustradas por ausência de bens da pessoa jurídica, com suspeita de"
  - "Desconsideração inversa: para atingir o patrimônio da PJ por dívidas pessoais do"
  - "Em relações de consumo: teoria menor — basta insolvência da empresa (art. 28, §5"
---
