---
name: civel_civel/manutencao_de_posse
description: >
  Gera petição inicial de ação de manutenção de posse, com fundamento nos arts. 560-566 do CPC/2015 e arts. 1.210-1.213 do CC/2002, para proteger o possuidor contra atos de turbação que perturbam, mas não eliminam, a posse do bem, com pedido de liminar inaudita altera parte quando 
triggers:
  - "Quando há turbação possessória (perturbação parcial da posse — o autor ainda pos"
  - "Para cessar interferências indevidas no exercício da posse (obras que invadem a "
  - "Quando o autor ainda tem a posse mas está ameaçado de perdê-la se não agir"
  - "Distinção crucial: turbação = perturbação parcial (manutenção de posse); esbulho"
---
