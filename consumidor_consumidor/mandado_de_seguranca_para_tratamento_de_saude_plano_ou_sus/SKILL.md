---
name: consumidor_consumidor/mandado_de_seguranca_para_tratamento_de_saude_plano_ou_sus
description: >
  Gera petição inicial de mandado de segurança para garantir direito líquido e certo a tratamento, medicamento, cirurgia ou insumo de saúde negado por plano de saúde (com pedido liminar contra a operadora) ou pelo poder público/SUS (contra autoridade coatora), fundamentada na Lei 1
triggers:
  - "Plano de saúde negou autorização para cirurgia, medicamento, exame ou internação"
  - "SUS/Secretaria de Saúde negou medicamento de alto custo, procedimento ou interna"
  - "Decisão administrativa de negativa de cobertura que precisa ser revertida com ur"
  - "Tratamento experimental negado — mas com evidência científica reconhecida por ór"
  - "Urgência: o estado de saúde não permite aguardar ação ordinária — o MS tem limin"
---

# Mandado de Segurança para Tratamento de Saúde (Plano ou SUS)
