---
name: consumidor_consumidor/negativacao_indevida_em_cadastros_de_protecao_ao_credito
description: >
  Gera petição inicial completa para ação declaratória de inexistência de débito cumulada com indenização por danos morais e pedido de tutela de urgência para exclusão imediata de inscrição indevida em cadastros restritivos (SPC, Serasa, SCPC e similares). Fundamentada nos arts. 43
triggers:
  - "Nome inscrito em cadastro restritivo por débito inexistente, prescrito ou já qui"
