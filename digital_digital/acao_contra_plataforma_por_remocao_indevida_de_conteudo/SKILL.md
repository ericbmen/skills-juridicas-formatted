...
- Do Direito:
  a) Da ilegitimidade da remoção (análise dos ToS)
  b) Do abuso de direito da plataforma (CC art. 187)
  c) Da responsabilidade civil por ato próprio (não aplicação do art. 19 MCI)
  d) Da relação de consumo (CDC)
  e) Da liberdade de expressão e vedação à censura (CF art. 5º, IX)
