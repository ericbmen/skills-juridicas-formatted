---
name: familia_familia/acao_negatoria_de_paternidade
description: >
  Gera petição inicial de ação negatória de paternidade para desconstituir o registro de paternidade que não corresponde à realidade biológica, fundamentada nos arts. 1.601, 1.608 e 1.614 do CC/2002, com pedido de exame de DNA e retificação do registro civil.
triggers:
  - "Pai registral que descobriu não ser o pai biológico e quer desconstituir o regis"
  ...
  - "Atenção: ação personalíssima do marido (art. 1.601 CC) — prazo decadencial pode "
---
...
2. Qualificação do autor e dos réus (mãe e/ou filho representado por curador especial)
3. Dos fatos — Como ocorreu o registro, como a ausência de paternidade foi descoberta
4. Da ausência de paternidade biológica — Dados do DNA (se já realizado) ou pedido de realização
5. Do vício de consentimento — Se aplicável
6. Do vínculo socioafetivo — Se inexistente ou insuficiente (argumento de distinção)
7. Do direito — Fundamentação legal (arts. 1.601 e ss. CC)
8. Dos danos morais — Se aplicável
9. Dos pedidos:
   a) Declaração judicial de inexistência de paternidade biológica
   b) Cancelamento/retificação do registro civil
   c) Produção de prova de DNA
   d) Nomeação de curador especial ao menor (se réu for menor)
   e) Danos morais (se aplicável)
10. Dos requerimentos — Citação, provas, gratuidade
