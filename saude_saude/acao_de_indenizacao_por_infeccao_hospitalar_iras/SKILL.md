---
name: saude_saude/acao_de_indenizacao_por_infeccao_hospitalar_iras
description: >
...
triggers:
  - "Quando o paciente internado adquiriu infecção hospitalar (pneumonia, sepse, MRSA"
  - "Para casos em que a infecção decorreu de falha nos procedimentos de controle de "
  - "Quando o material cirúrgico, prótese ou cateter estava contaminado e gerou infec"
  - "Para situações em que a infecção não foi tratada adequadamente após diagnóstico"
  - "Quando o hospital não possui ou não segue o Programa de Controle de Infecção Hos"
---
